...
@section('content')
    ...
    <ul class="nav nav-tabs">
        ...
        <li class=""><a   href="{{url('/package/add-package')}}"><i class="glyphicon glyphicon-arrow-left"></i> <span>Back</span></a></li>

    </ul>


    <h3 style="text-align: right;color: red;margin-right: 20px;"><i class="fa fa-adn" aria-hidden="true"></i> Add Package </h3>
    <form id="infoForm" class="form-horizontal" method="post" action="{{url('/package/update-newpackage')}}" name="editContentForm">
        {{csrf_field()}}
        ...
        <div id="phDiv" class="form-group">
            ...
            <div class="col-xs-5" style=" border-radius: 25px;">
                <input type="text" class="form-control" id="name" placeholder="Enter your package name" name="package_name" value="{{$packages->package_name}}">
            </div>
        </div>
        ...
        <div id="aDiv" class="form-group">
            ...
            <div class="col-xs-5">
                <textarea rows="2"  name="package_type" class="form-control" id="postalAddress" placeholder="Address Line">{{$packages->package_type}}</textarea>
            </div>
        ...
        <div id="phDiv" class="form-group">
            ...
            <div class="col-xs-5" style=" border-radius: 25px;">
                <input type="text" class="form-control" id="name" placeholder="Enter ammount" name="ammount" value="{{$packages->ammount}}">
            </div>
        </div>
    ...
    <script>
        document.forms['editContentForm'].elements['publication_status'].value='{{$packages->publication_status}}';
    </script>
