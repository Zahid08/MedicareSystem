...
@section('content')
    ...
    <ul class="nav nav-tabs">
        <li class=""><a  data-toggle="tab" href="#edit"><i class="glyphicon glyphicon-retweet"></i> <span>Edit</span></a></li>
        <li class=""><a   href="{{url('/patient/patient-list')}}"><i class="glyphicon glyphicon-arrow-left"></i> <span>Back</span></a></li>
    ...
    <div class="tab-content">
        <div id="edit" class=" tab-pane fade in active">
            ...
            <h3 style="text-align: right;color: red;margin-right: 20px;">EditPatient Information</h3>
            <form id="infoForm" class="form-horizontal">
                ...
                <div id="zDiv" class="form-group">
                    ...
                    <div class="col-xs-5">
                        <input type="file" class="form-control"  ><span> <a class="" href="#"><img src="" style="border-radius: 20%;" width="130" height="130" alt="No image uploaded"></a>
</span>
                    </div>
                </div>
                {{--publication status--}}
