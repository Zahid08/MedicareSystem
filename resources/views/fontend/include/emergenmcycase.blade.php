                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="{{asset('/font')}}/img/testimonials/1.jpg" alt="" class="person img-circle" />
                                    <a title="" href="#">Anna</a>
                            ...
                            <div class="col-md-4 col-sm-6 hidden-xs">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="{{asset('/font')}}/img/testimonials/2.jpg" alt="" class="person img-circle" />
                            ...
                            <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="{{asset('/font')}}/img/testimonials/3.jpg" alt="" class="person img-circle" />
                        ...
                        <div class="item">
                            <div class="col-md-4 col-sm-6">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="{{asset('/font')}}/img/testimonials/4.jpg" alt="" class="person img-circle" />
                            ...
                            <div class="col-md-4 col-sm-6 hidden-xs">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="{{asset('/font')}}/img/testimonials/5.jpg" alt="" class="person img-circle" />
                            ...
                            <div class="col-md-4 col-sm-6 hidden-sm hidden-xs">
                                ...
                                <div class="person-text rel text-light">
                                    <img src="{{asset('/font')}}/img/testimonials/6.jpg" alt="" class="person img-circle" />
